...
export default function GamePlan() {
  ...
  const canEdit = user && ["admin","head_coach","associate_head_coach","offensive_coordinator","defensive_coordinator","special_teams_coordinator","position_coach"].includes(user.role);
